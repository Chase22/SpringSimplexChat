...
function linkifyChars(str, opts) {
  ...
  for (var i = 0; i < tokens.length; i++) {
    ...
    var _opts$resolve = opts.resolve(token),
        ...
        attributes = _opts$resolve.attributes; // Build up attributes
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Chatconector", function() { return Chatconector; });
class Chatconector {
  constructor(chatId) {
    this.chatId = chatId;
  }
...
const connector = new _chatconector__WEBPACK_IMPORTED_MODULE_0__["Chatconector"](document.getElementById("chatid").value);
...
const updateMessages = () => {
  ...
  connector.getUpdates(lastId).then(data => {
    data.forEach(value => {
      if (!document.getElementById(value.id)) {
        ...
        const chatElemen = Object(_messageparser__WEBPACK_IMPORTED_MODULE_1__["createChatMessage"])(value);
  ...
  if (node != null && node.nodeType === Node.ELEMENT_NODE) {// node.scrollIntoView();
  }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createChatMessage", function() { return createChatMessage; });
...
/******/ });
//# sourceMappingURL=chatview.bundle.js.map